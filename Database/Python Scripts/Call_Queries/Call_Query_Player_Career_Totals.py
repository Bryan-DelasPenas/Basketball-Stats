...
'''
Function call query_player_career_totals_pid
'''
def call_query_all_player_career_totals_pid(player_id, playoffs):
    ...
    result = conn.execute(
    """
    CALL query_player_career_totals_pid(%s, %s)
    """, [playoffs, player_id]
    ).fetchall()
...
'''
Function call query_player_career_totals_pname
'''
def call_query_all_player_career_totals_pname(player_name, playoffs):
    ...
    result = conn.execute(
    """
    CALL query_player_career_totals_pname(%s, %s)
...
'''
Function call query_player_career_totals_both_pid
'''
def call_query_all_player_career_totals_both_pid(player_id):
    # Check parameter player_id with regex
    if(player_id_regex(player_id)):
        return None
    ...
    result = conn.execute(
    """
    CALL query_player_career_totals_both_pid(%s)
    """, [player_id]
    ).fetchall()
...
'''
Function call query_player_career_totals_both_pname
'''
def call_query_all_player_career_totals_both_pname(player_name):
    # Check parameter player_name with regex
    if(player_name_regex(player_name)):
        return None
    ...
    result = conn.execute(
    """
    CALL query_player_career_totals_both_pname(%s)
    """, [player_name]
    ).fetchall()
