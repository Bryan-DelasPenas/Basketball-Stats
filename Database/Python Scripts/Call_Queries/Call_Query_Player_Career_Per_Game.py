...
'''
Function call query_player_career_per_game_pid
'''
def call_query_all_player_career_per_game_pid(player_id, playoffs):
...
'''
Function call query_player_career_per_game_pname
'''
def call_query_all_player_career_per_game_pname(player_name, playoffs):
...
'''
Function call query_player_career_per_game_both_pid
'''
def call_query_all_player_career_per_game_both_pid(player_id):
    # Check parameter player_id with regex
    if(player_id_regex(player_id)):
        return None
...
'''
Function call query_player_career_per_game_both_pname
'''
def call_query_all_player_career_per_game_both_pname(player_name):
    # Check parameter player_name with regex
    if(player_name_regex(player_name)):
        return None
