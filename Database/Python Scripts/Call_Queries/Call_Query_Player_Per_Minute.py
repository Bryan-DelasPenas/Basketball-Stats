...
'''
def call_query_all_player_per_minute_pid(playoffs, player_id):
...
'''
def call_query_all_player_per_minute_sid_pid(playoffs, season_id, player_id):
    # Check parameter playoffs with regex 
    if(binary_regex(playoffs)):
        return None
...
'''
def call_query_all_player_per_minute_tid_pid(playoffs, team_id, player_id):
    # Check parameter playoffs with regex 
    if(binary_regex(playoffs)):
        return None
...
'''
def call_query_all_player_per_minute_pname(playoffs, player_name):
...
'''
def call_query_all_player_per_minute_pname_sid(playoffs, player_name, season_id):
    # Check parameter playoffs with regex 
    if(binary_regex(playoffs)):
        return None
...
'''
def call_query_all_player_per_minute_pname_tid(playoffs, player_name, team_id):
    # Check parameter playoffs with regex 
    if(binary_regex(playoffs)):
        return None
...
def call_query_all_player_per_minute_both_pname_sid(player_name, season_id):
    ...
    result = conn.execute(
    """
    CALL query_all_player_per_minute_both_pname(%s, %s)
