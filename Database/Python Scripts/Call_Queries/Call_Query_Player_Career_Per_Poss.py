...
'''
def call_query_player_career_per_poss_pid(player_id, playoffs):
...
'''
def call_query_player_career_per_poss_pname(player_name, playoffs):
...
'''
def call_query_player_career_per_poss_both_pid(player_id):
    # Check parameter player_id with regex
    if(player_id_regex(player_id)):
        return None
...
'''
def call_query_player_career_per_poss_both_pname(player_name):
    # Check parameter player_name with regex
    if(player_name_regrex(player_name)):
        return None
