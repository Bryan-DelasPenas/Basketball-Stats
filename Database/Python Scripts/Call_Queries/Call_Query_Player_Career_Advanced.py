...
'''
def create_query_player_career_advanced_pid(playoffs, player_id):
...
'''
def create_query_player_career_advanced_pname(playoffs, player_name):
...
'''
def create_query_player_career_advanced_both_pid(player_id):
    # Check parameter player_id with regex
    if(player_id_regex(player_id)):
        return None
...
'''
def create_query_player_career_advanced_both_pname(player_name):
    # Check parameter player_name with regex
    if(player_name_regrex(player_name)):
        return None
