...
'''
Function calls query_all_team_totals_sid
'''
def call_query_all_team_totals_sid(season_id, opp_bool):
...
'''
Function calls query_all_team_totals_tid
'''
def call_query_all_team_totals_tid(team_id, opp_bool):
...
'''
Function calls query_all_team_totals_sid_team
'''
def call_query_all_team_totals_sid_tid(season_id, team_id, opp_bool):
    # Check parameter season_id with regex
    if(season_id_regex(season_id)):
        return None
...
'''
Function calls query_all_team_totals_name
'''
def call_query_all_team_totals_name(team_name, opp_bool):
...
'''
Function calls query_all_team_totals_both_sid
'''
def call_query_all_team_totals_both_sid(season_id):
    # Check parameter season_id with regex
    if(season_id_regex(season_id)):
        return None
...
'''
Function calls query_all_team_totals_both_tid
'''
def call_query_all_team_totals_both_tid(team_id):
    # Check parameter team_id with regex
    if(team_id_regex(team_id)):
        return None
...
'''
Function calls query_all_team_totals_both_sid_tid
'''
def call_query_all_team_totals_both_sid_tid(season_id, team_id):
    # Check parameter season_id with regex
    if(season_id_regex(season_id)):
        return None
...
'''
Function calls query_all_team_totals_both_name
'''
def call_query_all_team_totals_both_name(team_name):
    # Check parameter team_name with regex
    if(team_name_regex(team_name)):
        return None
