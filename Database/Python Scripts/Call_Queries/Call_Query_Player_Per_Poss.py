...
'''
Function call query_all_player_per_poss_both_pid
'''
def call_query_all_player_per_poss_both_pid(player_id):
    # Check parameter player_id with regex
    if(player_id_regex(player_id)):
        return None
...
'''
Function call query_all_player_per_poss_both_sid_pid
'''
def call_query_all_player_per_poss_both_sid_pid(season_id, player_id):
    # Check parameter season_id with regex
    if(season_id_regex(season_id)):
        return None
...
'''
Function call query_all_player_per_poss_both_tid_pid
'''
def call_query_all_player_per_poss_both_tid_pid(team_id, player_id):
    # Check parameter team_id with regex
    if(team_id_regex(team_id)):
        return None
...
'''
Function call query_all_player_per_poss_both_pname
'''
def call_query_all_player_per_poss_both_pname(player_name):
    # Check parameter player_name
    if(player_name_regex(player_name)):
        return None
...
'''
Function call query_all_player_per_poss_both_pname_sid
'''
def call_query_all_player_per_poss_both_pname_sid(player_name, season_id):
    # Check parameter player_name
    if(player_name_regex(player_name)):
        return None
...
'''
Function call query_all_player_per_poss_both_pname_tid
'''
def call_query_all_player_per_poss_both_pname_tid(player_name, team_id):
    # Check parameter player_name
    if(player_name_regex(player_name)):
        return None
