...
from Call_Query_Player_Career_Per_Game import *
...
class TestQueryPlayerCareerPerGame(unittest.TestCase):
    ...
    def test_query_player_career_per_game_pname(self):
        ...
        df_result = call_query_player_career_per_game_pname("Kareem Abdul-Jabbar", 0)
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
    ...
    def test_query_player_career_per_game_both_pid(self):
        ...
        df_result = call_query_player_career_per_game_both_pid(2)
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
    ...
    def test_query_player_career_per_game_both_pname(self):
        ...
        df_result = call_query_player_career_per_game_both_pname("Kareem Abdul-Jabbar")
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
