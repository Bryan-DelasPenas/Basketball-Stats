...
from Call_Query_Player_Totals import *
...
class TestQueryPlayerTotals(unittest.TestCase):
    ...
    def test_query_all_player_totals_pid(self):
        ...
        df_result = call_query_all_player_totals_pid(2, 0)
    ...
    def test_query_all_player_totals_sid_pid(self):
        ...
        df_result = call_query_all_player_totals_sid_pid(1985, 2, 0)
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
    ...
    def test_query_all_player_totals_tid_pid(self):
        ...
        df_result = call_query_all_player_totals_tid_pid(14, 2, 0)
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
    ...
    def test_query_all_player_totals_pname(self):
        ...
        df_result = call_query_all_player_totals_pname("Kareem Abdul-Jabbar", 0)
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
    ...
    def test_query_all_player_totals_pname_sid(self):
        ...
        df_result = call_query_all_player_totals_pname_sid("Kareem Abdul-Jabbar", 1985, 0)
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
    ...
    def test_query_all_player_totals_pname_tid(self):
        ...
        df_result = call_query_all_player_totals_pname_tid("Kareem Abdul-Jabbar", 14, 0)
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
    ...
    def test_query_all_player_totals_both_pid(self):
        ...
        df_result = call_query_all_player_totals_both_pid(2)
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
    ...
    def test_query_all_player_totals_both_sid_pid(self):
        ...
        df_result = call_query_all_player_totals_both_sid_pid(1985, 2)
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
    ...
    def test_query_all_player_totals_both_tid_pid(self):
        ...
        df_result = call_query_all_player_totals_both_tid_pid(14, 2)
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
    ...
    def test_query_all_player_totals_both_pname(self):
        ...
        df_result = call_query_all_player_totals_both_pname("Kareem Abdul-Jabbar")
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
    ...
    def test_query_all_player_totals_both_pname_sid(self):
        ...
        df_result = call_query_all_player_totals_both_pname_sid("Kareem Abdul-Jabbar", 1985)
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
    ...
    def test_query_all_player_totals_both_pname_tid(self):
        ...
        df_result = call_query_all_player_totals_both_pname_tid("Kareem Abdul-Jabbar",14)
        df_result = df_result.astype({'Birth_Date': str})
        pd.testing.assert_frame_equal(df_result, df_expected)
