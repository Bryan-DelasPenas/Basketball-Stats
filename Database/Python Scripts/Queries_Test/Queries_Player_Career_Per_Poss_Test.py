...
class TestQueryPlayerCareerPerPoss(unittest.TestCase):
    ...
    def test_query_player_career_per_poss_pid(self):
        ...
        result = conn.execute(
        """
        CALL query_player_career_per_poss_pid(%s, %s)
        """, [0, 2]
        ).fetchall()
    ...
    def test_query_player_career_per_poss_pname(self):
        ...
        result = conn.execute(
        """
        CALL query_player_career_per_poss_pname(%s, %s)
    ...
    def test_query_player_career_per_poss_both_pid(self):
        ...
        result = conn.execute(
        """
        CALL query_player_career_per_poss_both_pid(%s)
        """, [2]
        ).fetchall()
    ...
    def test_query_player_career_per_poss_both_pname(self):
        ...
        result = conn.execute(
        """
        CALL query_player_career_per_poss_both_pname(%s)
        """, ["Kareem Abdul-Jabbar"]
        ).fetchall()
