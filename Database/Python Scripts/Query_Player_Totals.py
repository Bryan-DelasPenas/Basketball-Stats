...
def create_query_all_player_totals_pid():
    ...
    if not check_procedure('query_all_player_totals_pid'):
        try: 
            ...
            conn.execute(
            """
            CREATE PROCEDURE query_all_player_totals_pid(p_id int)
            BEGIN
               SELECT *
               FROM Player_Totals
...
def create_query_all_player_totals_sid_pid():
    ...
    if not check_procedure('query_all_player_totals_sid_pid'):
        try: 
            ...
            conn.execute(
            """
            CREATE PROCEDURE query_all_player_totals_sid_pid(s_id int, p_id int)
            BEGIN
               SELECT *
               FROM Player_Totals
   ...
   # Connect to sql database
    ...
    if not check_procedure('query_all_player_totals_tid_pid'):
        try: 
            ...
            conn.execute(
            """
            CREATE PROCEDURE query_all_player_totals_tid_pid(t_id int, p_id int)
            BEGIN
               SELECT *
               FROM Player_Totals
               Where Team_ID = t_id 
...
def create_query_all_player_totals_pname():
    ...
    if not check_procedure('query_all_player_totals_pname'):
        try: 
            ...
            conn.execute(
            """
            CREATE PROCEDURE query_all_player_totals_pname(pname LONGTEXT)
            BEGIN
               SELECT *
               FROM Player_Totals
...
def create_query_all_player_totals_pname_sid():
    ...
    if not check_procedure('query_all_player_totals_pname_sid'):
        try: 
            ...
            conn.execute(
            """
            CREATE PROCEDURE query_all_player_totals_pname_sid(pname LONGTEXT, s_id INT)
            BEGIN
               SELECT *
               FROM Player_Totals
               Where Player_Name = pname 
...
def create_query_all_player_totals_pname_tid():
    ...
    if not check_procedure('query_all_player_totals_pname_tid'):
        try: 
            ...
            conn.execute(
            """
            CREATE PROCEDURE query_all_player_totals_pname_tid(pname LONGTEXT, t_id INT)
            BEGIN
               SELECT *
               FROM Player_Totals
               Where Player_Name = pname 
