...
'''
Function that creates procedure for that queries Season_ID, Team_Name and one addtional input, from a inputed table, based on player_ID and Season_ID and an input
'''
def create_query_player_stats_one_above_sid_pid():
    # Connect to sql database
    engine = create_connection()
    ...
    if not check_procedure('query_player_stats_one_above_sid_pid'):
        try: 
            # Create a procedure
            conn.execute(
            """
            ...
            trans.commit()
            conn.close()
            print("Creation of procedure Query_Player_Stats_One_Above_Sid_Pid was Successful")
        except:
            raise Exception("Creation Procedure Query_Player_Stats_One_Above_Sid_Pid Failed")
    else:
        raise Exception("Procedure Query_Player_Stats_One_Above_Sid_Pid does exists")

'''
Function that creates procedure for that queries Season_ID, Team_Name and one addtional input, from a inputed table, based on player_ID and Season_ID and an input 
'''
def create_query_player_stats_two_above_sid_pid():
    # Connect to sql database
    engine = create_connection()
    ...
    if not check_procedure('query_player_stats_two_above_sid_pid'):
        try: 
            # Create a procedure
            conn.execute(
            """
            ...
            trans.commit()
            conn.close()
            print("Creation of procedure Query_Player_Stats_Two_Above_Sid_Pid was Successful")
        except:
            raise Exception("Creation Procedure Query_Player_Stats_Two_Above_Sid_Pid Failed")
    else:
        raise Exception("Procedure Query_Player_Stats_Two_Above_Sid_Pid does exists")

'''
Function that creates procedure for that queries Season_ID, Team_Name and one addtional input, from a inputed table, based on player_ID and Season_ID and an input
'''
def create_query_player_stats_three_above_sid_pid():
      # Connect to sql database
    engine = create_connection()
    ...
    if not check_procedure('query_player_stats_three_above_sid_pid'):
        try: 
            # Create a procedure
            conn.execute(
            """
            ...
            trans.commit()
            conn.close()
            print("Creation of procedure Query_Player_Stats_Three_Above_Sid_Pid was Successful")
        except:
            raise Exception("Creation Procedure Query_Player_Stats_Three_Above_Sid_Pid Failed")
    else:
        raise Exception("Procedure Query_Player_Stats_Three_Above_Sid_Pid does exists")
...
Drop Procedure query_player_stats_one_above_tid_pid
'''
def drop_query_player_stats_one_above_sid_pid():
    # Connect to sql database
    engine = create_connection()
    ...
    if check_procedure('query_player_stats_one_above_sid_pid'):
        try: 
            # Create a procedure
            conn.execute(
            """
            DROP PROCEDURE IF EXISTS query_player_stats_one_above_sid_pid
            """)
            trans.commit()
            conn.close()
            print("Deletion of procedure Query_Player_Stats_One_Above_Sid_Pid was Successful")
        except:
            raise Exception("Deletion of Procedure Query_Player_Stats_One_Above_Sid_Pid Failed")
    else:
        print("Procedure Query_Player_Stats_One_Above_Sid_Pid does not Exists")

'''
Drop Procedure query_player_stats_two_above_tid_pid
'''
def drop_query_player_stats_two_above_sid_pid():
     # Connect to sql database
    engine = create_connection()
    ...
    if check_procedure('query_player_stats_two_above_sid_pid'):
        try: 
            # Create a procedure
            conn.execute(
            """
            DROP PROCEDURE IF EXISTS query_player_stats_two_above_sid_pid
            """)
            trans.commit()
            conn.close()
            print("Deletion of procedure Query_Player_Stats_Two_Above_Sid_Pid was Successful")
        except:
            raise Exception("Deletion of Procedure Query_Player_Stats_Two_Above_Sid_Pid Failed")
    else:
        print("Procedure Query_Player_Stats_Two_Above_Sid_Pid does not Exists")

'''
Drop Procedure query_player_stats_three_above_tid_pid
'''
def drop_query_player_stats_three_above_sid_pid():
    # Connect to sql database
    engine = create_connection()
    ...
    if check_procedure('query_player_stats_three_above_sid_pid'):
        try: 
            # Create a procedure
            conn.execute(
            """
            DROP PROCEDURE IF EXISTS query_player_stats_three_above_sid_pid
            """)
            trans.commit()
            conn.close()
            print("Deletion of procedure Query_Player_Stats_Three_Above_Sid_Pid was Successful")
        except:
            raise Exception("Deletion of Procedure Query_Player_Stats_Three_Above_Sid_Pid Failed")
    else:
        print("Procedure Query_Player_Stats_Three_Above_Sid_Pid does not Exists")
...
def drop_player_stats_query():
    ...
    drop_query_player_stats_one_above_sid_pid()
    drop_query_player_stats_two_above_sid_pid()
    drop_query_player_stats_three_above_sid_pid()
