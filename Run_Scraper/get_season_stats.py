...
from helper.py import create_output_child_directory, create_output_directory
...
def get_team_csv(): 
    ...
    for year in range(1980, 2021):
        csv_team_stats(year, 'PER_GAME')
        csv_team_stats(year, 'PER_POSS')
        csv_team_stats(year, 'TOTAL')
        csv_roster(year)
